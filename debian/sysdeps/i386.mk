...
#libc_extra_config_options = $(extra_config_options) --with-tls --without-__thread --disable-force-install

# NPTL Config
nptl_add-ons = nptl ports $(add-ons)
nptl_extra_config_options = $(extra_config_options) --with-fp --with-tls --with-__thread --disable-profile --disable-force-install
